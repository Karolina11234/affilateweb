...
.wtb-coupon-until { font-size: .74rem; letter-spacing: .04em; opacity: .8; }
.wtb-coupon-copy {
...
.wtb-post-single {
  ...
  padding: 46px; max-width: 800px; margin: 0 auto 40px;
}
.wtb-post-single .wtb-card-cat { margin-bottom: 14px; }
.wtb-post-single h1 { font-size: clamp(1.8rem, 4vw, 2.6rem); margin-bottom: 14px; }
.wtb-post-single .wtb-post-date {
  font-size: .85rem; color: rgba(26,26,38,.55); font-style: italic;
...
.wtb-post-single .wtb-post-body { color: #2c2c3a; font-size: 1rem; }
